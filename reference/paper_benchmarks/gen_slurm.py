...
#SBATCH --output=/nlp/data/REDACTED/logs/%j.%x.log
#SBATCH --error=/nlp/data/REDACTED/logs/%j.%x.log
#SBATCH --time=7-0
#SBATCH -c {cpus}
#SBATCH --mem={mem}
#SBATCH --gpus={gpus}
{gpuconstraint}
export WIKI_CACHE_DIR=/nlp/data/REDACTED/fanoutqa-bench/.wikicache
